...
public enum ItemType {
    ...
    BRENNER("Brenner", "/assets/items/brenner.png", 1),
    ...
    FELDSTECHER("Feldstecher", "/assets/items/feldstecher.png", 0),
    GLUEHBIRNE("Glühbirne", "/assets/items/glühbirne.png", 1),
    IKOSAEDER("Ikosaeder", "/assets/items/ikosaeder.png", 0),
    ...
    MAGNET("Magnet", "/assets/items/magnet.png", 2),
    MIKROSKOP("Mikroskop", "/assets/items/mikroskop.png", 1),
    ...
    SCHUTZBRILLE("Schutzbrille", "/assets/items/schutzbrille.png", 0),
    SCHAEDEL("Schädel", "/assets/items/schädel.png", 0),
    ...
    TASTATUR("Tastatur", "/assets/items/tastatur.png", 1),
    ...
    SCHLÜSSELANHÄNGERDINGS("Schlüsselbund", "/assets/items/nichtsnichts.png", 99),
    ...
    public static List<ItemType> getItems(Department fachschaft) { // Items mit jeweiligen Leveln an Lehrer mit jeweiligen Leveln  verteilen
        if (fachschaft == Department.COMPUTER_SCIENCE) {
            ...
            return List.of(  //die Items werden zurückgegeben
                    ...
                    ItemType.WLAN, //level 1
                    ItemType.CHROME,//level 2
                    ItemType.TASTATUR,//level 2
            ...
            return List.of(
                    ...
                    ItemType.FELDSTECHER, //level 1
                    ItemType.MAGNET,//level 2
                    ItemType.GLUEHBIRNE,//level 2
                    ItemType.THERMOMETER//level 3
            );
            ...
            return List.of(
                    ...
                    ItemType.IKOSAEDER, //level 1
                    ItemType.THALES,//level 2
                    ItemType.ZETTEL,//level 2
                    ItemType.CAS//level 3
            );  
            ...
            return List.of(
                    ...
                    ItemType.SCHAEDEL, //level 1
                    ItemType.DNA,//level 2
                    ItemType.MIKROSKOP,//level 2
            ...
            return List.of(
                    ...
                    ItemType.SCHUTZBRILLE, //level 1
                    ItemType.WUNDERKERZE,//level 2
                    ItemType.BRENNER,//level 2
                    ItemType.SAEURE//level 3
            );
        } else {
            throw new RuntimeException("BRO java is actually doch nicht so tuff" + "Ja wer hätte das denn erwartet...");
        }
    }
}
