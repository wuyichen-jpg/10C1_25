...
\begin{frame}
    ...
    \begin{itemize}
        \item \texttt{ComputerScienceLevelScene} \pause
            \begin{itemize}
...
\begin{frame}
	\frametitle{Umsetzung}
    \begin{itemize}
        \item \texttt{MathematicsLevelScene} \pause
            \begin{itemize}
                \item Erweiterung der \texttt{LevelScene} \pause
                \item Platzierung der Form und der Steine \pause
            \end{itemize}
        \item \texttt{TangramPieceObject} \pause
            \begin{itemize}
                \item Erweiterung des \texttt{BaseObjects} \pause
                \item Bereitstellung des Bildes, sowie Funktionen zum Bewegen und Rotieren \pause
            \end{itemize}
        \item \texttt{MathematicsPuzzle} \pause
            \begin{itemize}
                \item Enumeration \pause
...
\begin{itemize}
        ...
        \begin{itemize}
            ...
            \item Spieler*in zieht Kraftpfeil vom Ball weg (\texttt{kraftRichtung}: \texttt{"RIGHT"} / \texttt{"UP"})
            \item \texttt{simulateButton} startet die Simulation
        \end{itemize} 
 \pause
        \item \textbf{Phase 2 – Simulation} 
        \begin{itemize} 
            \item \texttt{simulationStarten()} übernimmt Spielerkraft als Startgeschwindigkeit
            \item \texttt{ballBewegen()} wendet \texttt{basisBeschleunigungen} an
            \item prüft Kollisionen mit Rand, Wand, Ziel
        \end{itemize}
 \pause
